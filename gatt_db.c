...
, 
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_80 ) = {
	.len=19,
	.data={0x02,0x52,0x00,0xef,0x2c,0x92,0xc4,0xaa,0x37,0xee,0x9b,0xe5,0x46,0x8e,0xa7,0x2a,0xf0,0x83,0x65,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_78 ) = {
	.len=19,
	.data={0x08,0x50,0x00,0xef,0x2c,0x92,0xc4,0xaa,0x37,0xee,0x9b,0xe5,0x46,0x8e,0xa7,0x2b,0xf0,0x83,0x65,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_76 ) = {
	.len=19,
	.data={0x0a,0x4e,0x00,0xa1,0xf9,0x56,0xd2,0x4b,0xcb,0xaf,0xa2,0x11,0x4d,0x20,0x32,0xf1,0x69,0x3f,0xd9,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_74 ) = {
	.len=19,
	.data={0x0a,0x4c,0x00,0xa1,0xf9,0x56,0xd2,0x4b,0xcb,0xaf,0xa2,0x11,0x4d,0x20,0x32,0xf0,0x69,0x3f,0xd9,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_72 ) = {
	.len=19,
	.data={0x0a,0x4a,0x00,0xa1,0xf9,0x56,0xd2,0x4b,0xcb,0xaf,0xa2,0x11,0x4d,0x20,0x32,0xef,0x69,0x3f,0xd9,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_71 ) = {
	.len=16,
	.data={0x57,0x60,0x90,0x8d,0x1b,0x36,0x20,0xab,0xfe,0x4a,0x80,0x0a,0x3d,0xb7,0x42,0x0e,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_68 ) = {
	.len=19,
	.data={0x12,0x46,0x00,0xee,0x96,0x09,0xc7,0x79,0x01,0x6f,0x90,0xf8,0x45,0x7d,0x1e,0x54,0x9d,0x20,0x36,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_66 ) = {
	.len=19,
	.data={0x0c,0x44,0x00,0xee,0x96,0x09,0xc7,0x79,0x01,0x6f,0x90,0xf8,0x45,0x7d,0x1e,0x53,0x9d,0x20,0x36,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_64 ) = {
	.len=19,
	.data={0x08,0x42,0x00,0xee,0x96,0x09,0xc7,0x79,0x01,0x6f,0x90,0xf8,0x45,0x7d,0x1e,0x52,0x9d,0x20,0x36,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_62 ) = {
	.len=19,
	.data={0x08,0x40,0x00,0xee,0x96,0x09,0xc7,0x79,0x01,0x6f,0x90,0xf8,0x45,0x7d,0x1e,0x51,0x9d,0x20,0x36,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_61 ) = {
	.len=16,
	.data={0x65,0x7e,0xce,0x26,0x54,0x02,0xd0,0xbd,0xaf,0x41,0x67,0xa9,0x88,0x75,0x1d,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_55 ) = {
	.len=19,
	.data={0x02,0x39,0x00,0x67,0xff,0x4c,0x98,0x41,0xa2,0xd6,0x9a,0x58,0x43,0x00,0x00,0x24,0x2a,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_52 ) = {
	.len=19,
	.data={0x1a,0x36,0x00,0x67,0xff,0x4c,0x98,0x41,0xa2,0xd6,0x9a,0x58,0x43,0x00,0x00,0x23,0x2a,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_50 ) = {
	.len=19,
	.data={0x0a,0x34,0x00,0x67,0xff,0x4c,0x98,0x41,0xa2,0xd6,0x9a,0x58,0x43,0x00,0x00,0x22,0x2a,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_48 ) = {
	.len=19,
	.data={0x02,0x32,0x00,0x44,0x43,0x7d,0x45,0xbb,0xa5,0x18,0xab,0xdd,0x48,0xd3,0x94,0xbd,0x48,0xb9,0xc0,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_45 ) = {
	.len=19,
	.data={0x12,0x2f,0x00,0x67,0xff,0x4c,0x98,0x41,0xa2,0xd6,0x9a,0x58,0x43,0x00,0x00,0x20,0x2a,0x00,0x00,}
};
...
struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_10_data = {
	.len=12,
	.data={0x57,0x65,0x69,0x72,0x20,0x55,0x4e,0x4e,0x41,0x4d,0x45,0x44,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x800b,.permissions=0x801,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_46},
    ...
    {.uuid=0x800c,.permissions=0x801,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_49},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_50},
    {.uuid=0x800d,.permissions=0x803,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_51},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_52},
    {.uuid=0x800e,.permissions=0x803,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_53},
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x10,.clientconfig_index=0x07}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_55},
    {.uuid=0x800f,.permissions=0x801,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_56},
    ...
    {.uuid=0x000b,.permissions=0x801,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_59},
    {.uuid=0x000c,.permissions=0x803,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x12,.clientconfig_index=0x08}},
    ...
    {.uuid=0x8011,.permissions=0x802,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_63},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_64},
    {.uuid=0x8012,.permissions=0x802,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_65},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_66},
    {.uuid=0x8013,.permissions=0x806,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_67},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_68},
    {.uuid=0x8014,.permissions=0x801,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_69},
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x16,.clientconfig_index=0x09}},
    ...
    {.uuid=0x8016,.permissions=0x803,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_73},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_74},
    {.uuid=0x8017,.permissions=0x803,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_75},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_76},
    {.uuid=0x8018,.permissions=0x803,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_77},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_78},
    {.uuid=0x8019,.permissions=0x802,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_79},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_80},
    {.uuid=0x801a,.permissions=0x801,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_81},
};
...
GATT_DATA(const uint8_t bg_gattdb_data_adv_uuid128_map[])={0x67, 0xff, 0x4c, 0x98, 0x41, 0xa2, 0xd6, 0x9a, 0x58, 0x43, 0x00, 0x00, 0x00, 0x1a, 0x00, 0x00, };
